...
<html lang="en">
  <head>
	...
	<title>Furniture Admin | Edit Category</title>
...
if (isset($_POST['id'])) {
	...
	$id = $_POST['id'];
	$data = $db->select("*", "category", "id='$id'");
	$category_data = $data->fetch(pdo::FETCH_ASSOC);
}
...
if (isset($_POST['update'])) {
	...
	$db->update("category", "category='$category'", "id='$id'");
									...
									<form  method="POST" action="<?php echo $_SERVER["PHP_SELF"] ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="add-category" name="category" value="<?php echo $category_data['category']  ?>" required="required" class="form-control ">
