...
<?php
//require("./admin/furnitures.php");
require("./admin/database.php");
$db = new DB();
$db->get_connection();
//SELECT * FROM furniture WHERE order by id DESC limit 3
//  SELECT * FROM `furniture` WHERE ORDER BY id DESC LIMIT 3

// run     SELECT * FROM `furniture` WHERE id ORDER BY id DESC LIMIT 3

$data = $db->select("*", "furniture"," id ORDER BY id DESC LIMIT 8");
...
foreach ($furnitures as $furniture) {
   ...
   ?>
                  ...
                  <a href="productpage.php?id=<?php echo  $furniture['id']  ?>">

                     <!-- <a href="productpage.php"> -->
                        <div class="box-img">
                           <h4><?php echo $furniture['title']  ?></h4>



                           <!-- <img src="images/product/1.png" alt="" /> -->
<!-- <?php echo $furniture['image']  ?> -->
<!-- cat-img-02.jpg -->
<!-- src="./admin/images/cat-img-02.jpg" -->
                           <img src="./admin/images/<?php echo $furniture['image']  ?>" alt="" />
                        </div>
                     </a>
                  </div>
          <?php
