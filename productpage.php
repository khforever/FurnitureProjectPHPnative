...
$id = $_GET['id'];
$data = $db->select("*", "furniture"," id='$id'");
...
$y=$db->select("id","category"," id='$e'");
$e=$y->fetch(pdo::FETCH_ASSOC);
$c= implode(" ",$e);
...
$result =$db->select("*","furniture","id!='$id' && category='$c' && image ORDER BY image LIMIT 4");
...
<h1><div class="tab-pane active" id="pic-1"><?php echo $furniture['title']  ?></div></h1>
                                 <div class="tab-pane active" id="pic-1"><img src="./admin/images/<?php echo $furniture['image']  ?>" alt="#" /></div>
...
?>
                     ...
                     <div class="description-box">
                        <div class="dex-a">
                           <h4><?php echo $furniture['description']  ?></h4>
                           ...
                           <br>
                           <h5><p>Small :<?php echo $furniture['small']  ?> cm</p>
                           <p>Large :<?php echo $furniture['large']  ?>  cm</p>
                           <p>The price :<?php echo $furniture['price']  ?>  LE</p> </h5>
                        </div>
                        ...
                        <div class="col-md-6">
                           <div class="small-box-c">
                              <div class="small-img-b">
                                 <img class="img-responsive" src="./admin/images/<?php echo $caty['image']  ?>" alt="#" />
                              </div>
                              <div class="dit-t clearfix">
                                 <div class="left-ti">
                                    <h4><?php echo $caty['title']  ?></h4>
                                    <p>By <span>Beko</span> under <span>Lights</span></p>
                                 </div>
                                 <a href="#" tabindex="0"><?php echo $caty['price']  ?>LE</a>
                              </div>
                              <div class="prod-btn">
                                 <a href="#"><i class="fa fa-star" aria-hidden="true"></i> Save to wishlist</a>
                                 <a href="#"><i class="fa fa-thumbs-up" aria-hidden="true"></i> Like this</a>
...
?>
                     ...
                     <h3><?php echo $furniture['price']  ?> <span> pr.peice</span></h3>
